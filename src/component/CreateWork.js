        ...
        <div className="create-work-box" >
            ...
            <div className="work-name-box">
                ...
                <div className="work-name-sec2">
                    ...
                    <input className='work-Input' type='text' name='input_project' value={inputProject} onChange={handleInputProject} />
                </div>
            </div>
            ...
            <div className="createWorkBtn-box">
                <button className='createWorkBtn' type='button' onClick={ onClickButton }>생성</button>
            </div>
