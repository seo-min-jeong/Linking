...
function PageNoti(props) {
    ...
    const filteredData = newData.filter((item) => item.isChecked)

    return(
        <div >
            <div>
                <div><img className="lookImg" src={ look } onClick={ onClickLook } /></div>
                <div><span className="lookTxt" onClick={ onClickLook }>{filteredData.length}명</span></div>
            </div>
            <div className={isLook ? "look-show-menu" : "look-hide-menu"}>
                <div className="look-showSec-box">
                    <img className="look-secImg" src={ totalUser }/>
                        <span className="look-name-txt" onClick={onClickTotalAlarm}>전체 알림 보내기</span>
                        ...
                        >
                            <div className="send-noti-box">
                                <div className="look-bell-box1">
                                    <div className="look-bell-box"><span className="look-bell-txt" onClick={() => onClickWebAndMail(0)}>Web & Mail</span></div>
                                    <div><img className="look-bell-img" src={ bellRed } onClick={() => onClickWebAndMail(0)}/></div>
                                </div>
                                <div className="look-bell-box2">
                                    <div className="look-bell-box"><span className="look-bell-txt" onClick={() => onClickWeb(0)}>Web</span></div>
            ...
            {array.map((noti, i) => (
                <div className="look-showSec-box" key={i} >
                    ...
                    <span className="look-name-txt" onClick={() => onClickArrow(i)}>{noti.userName}</span>
                    ...
                    <div>
                        ...
                        >
                            <div className="send-noti-box">
                                <div className="look-bell-box1">
                                    <div className="look-bell-box"><span className="look-bell-txt" onClick={() => onClickWebAndMail(i)}>Web & Mail</span></div>
                                    <div><img className="look-bell-img" src={ bellRed } onClick={() => onClickWebAndMail(i)}/></div>
                                </div>
                                <div className="look-bell-box2">
                                    <div className="look-bell-box"><span className="look-bell-txt" onClick={() => onClickWeb(i)}>Web</span></div>
